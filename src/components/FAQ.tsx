...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Просто позвоните или напишите в мессенджер — номер телефона внизу страницы. Опишите задачу, назовите адрес, и мы согласуем удобное время. Работаю с 8:00 до 22:00 без выходных.",
  },
]
